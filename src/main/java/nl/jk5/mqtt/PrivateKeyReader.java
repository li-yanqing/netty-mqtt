...
/**
 * Class for reading RSA private key from PEM file. It uses the JMeter FileServer to find the file. So the file should
 * be located in the same directory as the test plan if the path is relative.
 * 
 * <p/>
 * There is a cache so each file is only read once. If file is changed, it will not take effect until the program
 * restarts.
 * 
 * <p/>
...
public class PrivateKeyReader {
    ...
    private static Map<String, PrivateKey> keyCache        = Collections
            .synchronizedMap(new HashMap<String, PrivateKey>());
